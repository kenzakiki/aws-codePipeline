aws cloudformation create-stack --stack-name aws-code-pipeline --template-body file://cfn/pipeline-cfn.yaml  --parameters file://cfn/params.json --capabilities CAPABILITY_NAMED_IAM
